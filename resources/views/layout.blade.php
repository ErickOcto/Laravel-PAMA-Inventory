...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo me-1">
                <a href="{{ route('dashboard') }}" class="d-flex align-items-center"><img src="/image/esemka6.png" alt="Logo" srcset="" class="me-1" style="min-height: 48px">SMK6</a>
            </div>
